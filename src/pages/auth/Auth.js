...
const Auth =  observer(() => {
    ...
    return (
<div style={{
    backgroundImage: "url("+"https://storage.picsave.pp.ua/cluster1/origin/0af363a589ffa4f3337e99f6739fb16a.jpg"+")"
}}>
        ...
        >
            <Card style={{width: 600}} className="p-5">
                ...
                <Row className="d-flex justify-content-between mt-3">
                    ...
                    <RadioGroup name="fruits" onChange={(v) => updateRadioButton(v)}>
                        <div className="radio-button-background d-inline-block mt-3 m-4">
                            <Radio value="ImpoverishedAuth" className="radio-button" defaultChecked/> Я бабка
                        </div>
                        <div className="radio-button-background d-inline-block mt-3 m-4">
                            <Radio value="VolonteerAuth" className="radio-button"/> Я волонтёр
                        </div>
                        <div className="radio-button-background d-inline-block mt-3 m-4">
